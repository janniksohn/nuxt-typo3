...
const props = defineProps({
  ...
  target: { type: [String, Object, null], required: true },
  displayFileSizeInformation: { type: String, required: false },
  displayDescription: { type: String, required: false },
  displayInformation: { type: String, required: false },
