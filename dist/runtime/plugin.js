...
import { T3ApiClient } from "./lib/apiClient.js";
import { t3i18nMiddleware } from "./middleware/i18n.js";
import { t3initialDataMiddleware } from "./middleware/initialData.js";
...
export const hydrateT3ClientHeaders = (client) => {
  useHydration(
    "T3:api:headers",
    () => {
